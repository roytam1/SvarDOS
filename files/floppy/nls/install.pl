...
0.5:Naciûnij cokolwiek...
0.6:Formatuj

### LANGUAGE SELECTION SCREEN ###
1.0:Witaj w systemie Svarog386
1.1:Wybierz tw¢j jëzyk z ponißszej listy:
...
2.3:UWAGA: Jeûli tw¢j komputer posiada juß inny system operacyjny, system ten
2.4:       moße nie zdoíaç sië uruchomiç po instalacji Svarog386.
#
